            ...
            Parallel 
                {
                    ...
                    Invoke-WebRequest "https://raw.githubusercontent.com/likamrat/arcbox-1/replace_func/scripts/settings_template.json" -OutFile "C:\ArcBox\settings_template.json"
                    Invoke-WebRequest "https://aka.ms/azdata-msi" -OutFile "C:\ArcBox\AZDataCLI.msi"
                    Invoke-WebRequest "https://raw.githubusercontent.com/likamrat/arcbox-1/replace_func/scripts/ArcServersLogonScript.ps1" -OutFile "C:\ArcBox\ArcServersLogonScript.ps1"
                    Invoke-WebRequest "https://raw.githubusercontent.com/likamrat/arcbox-1/replace_func/scripts/DataServicesLogonScript.ps1" -OutFile "C:\ArcBox\DataServicesLogonScript.ps1"
                    Invoke-WebRequest "https://raw.githubusercontent.com/likamrat/arcbox-1/replace_func/scripts/installArcAgent.ps1" -OutFile "C:\ArcBox\agentScript\installArcAgent.ps1"
                    Invoke-WebRequest "https://raw.githubusercontent.com/likamrat/arcbox-1/replace_func/scripts/installArcAgentSQL.ps1" -OutFile "C:\ArcBox\agentScript\installArcAgentSQL.ps1"
                    Invoke-WebRequest "https://raw.githubusercontent.com/likamrat/arcbox-1/replace_func/scripts/installArcAgent.sh" -OutFile "C:\ArcBox\agentScript\installArcAgent.sh"
                }
        }
