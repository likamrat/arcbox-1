...
(Get-Content -path "$agentScript\ArcAgentSQL2.ps1" -Raw) -replace '\$myResourceGroup',"'$env:myResourceGroup'" | Set-Content -Path "$agentScript\ArcAgentSQL3.ps1"
...
(Get-Content -path "$agentScript\ArcAgent2.sh" -Raw) -replace '\$myResourceGroup',"'$env:myResourceGroup'" | Set-Content -Path "$agentScript\ArcAgent3.sh"
